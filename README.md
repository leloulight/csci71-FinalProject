...
Story Title: Support registration - 3. 
...
Story Title: Support account recovery - 3.
...
Story Title: Create categories - 3.
...
Story Title: Set user profile/preferences - 10.
...
Story Title: Create list items - 10.
...
Story Title: Mark items as done - 1.
...
Story Title: Automatically increment task number when a new task is created - 1.
...
Story Title: Sort list items (set item preferences) - 10.
...
Story Title: Create burndown chart visualizations / analytics - 10.
...
Story Title: Create email reminders for each item - 5.
...
Story Title: Create search tool for use on all metadata items - 5.
...
Story Title: Assign list items to users - 3.
...
Story Title: Create individual calendar visual - 10.
...
Story Title: Create Text reminders for each item - 5.
...
Story Title: Export to Excel - 10.
...
Story Title: Share categories with other users - 3.
...
Story Title: Create team calendar visual - 10.
...
Story Title: Create option to make a task private - 10.
...
Story Title: Assign various levels of access control (admin, manager, etc.) - 20.
...
Story Title: Create global preferences for turning on/off ALL email and text reminders - 5.
...
Story Title: Create option to add myself to watch list if task is not private - 5.
...
Story Title: Support two-factor authentication - 10.
...
Story Title: Support items changing color / flashing when deadline is approaching - 10.
...
Story Title: Support Slack integration - 20.
...
Story Title: Remind me when I am at… (Geofencing) - 10.
...
Story Title: iOS and Android application support - 20.
